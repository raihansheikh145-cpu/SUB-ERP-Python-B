...
companies = [
    {'id': 'd9dbb775-6839-4201-9dda-caa39e271201'},
    {'id': 'fa25c50f-2980-43ef-bb4c-14493734bede'},
    {'id': 'cbf98256-8950-4a30-9c56-0a75ba9d461b'},
    {'id': '1948eec5-5894-46c6-bb94-e7ef65609857'},
    {'id': '6e118177-329f-4cfa-a99d-180f3e73b02a'},
    {'id': 'f26e3d6f-390b-4cb2-ab54-c73329534495'},
    {'id': '8d5aa9db-fe65-4731-9a5d-5fa2b94f014f'}
]
...
for comp in companies:
    ...
    for acc in INITIAL_ACCOUNTS:
        ...
        sql_commands.append(
            f"INSERT INTO docs_accounts (id, company_id, code, name, type, data) "
            f"VALUES ('{acc_id}', '{c_id}', '{acc['code']}', '{escaped_name}', '{acc['type']}', '{escaped_data}') "
            f"ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, data = EXCLUDED.data;"
        )

with open('seed_accounts.sql', 'w', encoding='utf-8') as f:
    f.write('\\n'.join(sql_commands))

print('Generated seed_accounts.sql')
